  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        data-oid="7klgzy4"
      >
        <div className="container mx-auto px-4" data-oid="fhurs__">
          <p className="text-sm mb-2" data-oid="g-kgtme">
            Scroll to explore
          </p>
          <motion.div
            animate={{ y: [0, 8, 0] }}
            ...
            data-oid="s0a7xxd"
          >
            <ArrowDown className="h-6 w-6" data-oid="bab3jlv" />
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <div
          ...
          data-oid="uehtdh4"
        ></div>
        <span data-oid=":yhl5z3">Real Estate</span>
        <div
          className="w-2 h-2 rounded-full bg-[#F0A500] ml-2"
          data-oid="sgooqyq"
        ></div>
        <span data-oid="u8et0kz">Finance</span>
        <div
          className="w-2 h-2 rounded-full bg-[#79123B] ml-2"
          data-oid="bqpo..:"
        ></div>
        <span data-oid="vrylaaf">Learning</span>
      </div>
    </section>
  );
}
