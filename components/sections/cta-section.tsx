...
export default function CtaSection() {
  ...
  return (
    <section
      ...
      data-oid="0ffs_u9"
    >
      <div className="container mx-auto px-4 relative z-10" data-oid="unhjsjc">
        <div
        ...
        >
          ...
          <div className="flex justify-center" data-oid="f1b0ucy">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{
                opacity: isInView ? 1 : 0,
            ...
            >
              <Button
                ...
                data-oid="n8ywve6"
              >
                <BookOpen className="mr-2 h-5 w-5" data-oid="qgilarw" />
                Explore Courses
                <ArrowRight className="ml-2 h-5 w-5" data-oid="cuimk0k" />
              </Button>
            </motion.div>
          </div>
        </div>
