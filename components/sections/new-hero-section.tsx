...
export default function NewHeroSection() {
  ...
  return (
    ...
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5" data-oid="bzd:-1g">
        <div
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="akra3yh">
        <div className="max-w-6xl mx-auto" data-oid="9i109m_">
          <div
            className="grid lg:grid-cols-2 gap-12 items-center"
            data-oid="vok:4wv"
          >
            {/* Left Content */}
            <div className="text-center lg:text-left" data-oid="ydo0ef1">
              <motion.div
                ...
                data-oid="fxj.3y3"
              >
                <Star className="w-4 h-4 fill-current" data-oid="jww9wbq" />
              ...
              >
                Master Real Estate
                <span className="block text-primary" data-oid="i9hf15z">
                  Investment
                </span>
              </motion.h1>
              ...
              <motion.div
                ...
                data-oid=".__4vzv"
              >
                <Link href="/courses" data-oid="75lta:.">
                  <Button
                    size="lg"
              ...
              <motion.div
                ...
                data-oid="98.4fmz"
              >
                <div className="text-center lg:text-left" data-oid="ptqun3z">
                  <div
                    className="flex items-center gap-2 text-gray-600 mb-1"
                    data-oid="wfb53.."
                  >
                    <Users className="w-5 h-5" data-oid="rxa_0:a" />
                    <span className="text-sm font-medium" data-oid="noe-jv:">
                      Students
                    </span>
                  </div>
                  <div
                ...
                <div className="text-center lg:text-left" data-oid="npcjkqt">
                  <div
                    className="flex items-center gap-2 text-gray-600 mb-1"
                    data-oid="hgyqc0w"
                  >
                    <BookOpen className="w-5 h-5" data-oid="67gf3-g" />
                    <span className="text-sm font-medium" data-oid="_960-w7">
                      Courses
                    </span>
                  </div>
                  <div
                ...
                <div className="text-center lg:text-left" data-oid="o5-v:su">
                  <div
                    className="flex items-center gap-2 text-gray-600 mb-1"
                    data-oid="r9b:zkb"
                  >
                    <Star className="w-5 h-5" data-oid="y--x-9p" />
                    <span className="text-sm font-medium" data-oid="qwbd3_v">
                      Rating
                    </span>
                  </div>
                  <div
            ...
            <motion.div
              ...
              data-oid="aiy305n"
            >
              <div className="relative" data-oid="xyvl663">
                {/* Main Card */}
                <div
                ...
                >
                  ...
                  >
                    ...
                    <div data-oid="8-pcrai">
                      ...
                      <p className="text-gray-500 text-sm" data-oid=".m728dh">
                        By Melvin Lim
                      </p>
                    </div>
                  </div>

                  <div className="space-y-4 mb-6" data-oid="hkj4ca4">
                    <div
                      className="flex justify-between items-center"
                      data-oid="km0d:z5"
                    >
                      <span className="text-gray-600" data-oid="3.mhjzf">
                        Progress
                      </span>
                      <span
                  ...
                  <div
                    ...
                    data-oid="5_o5713"
                  >
                    <div className="flex items-center gap-2" data-oid="hgrtabt">
                      <Star
                ...
                <motion.div
                  ...
                  data-oid=".kbnxw."
                >
                  <div className="text-sm font-medium" data-oid="t0igxdh">
                    ROI Achieved
                  </div>
                  <div className="text-2xl font-bold" data-oid="zt..3yn">
                    +127%
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  data-oid="up6g5.u"
                >
                  <div className="flex items-center gap-2" data-oid="n:d6-ya">
                    <div
