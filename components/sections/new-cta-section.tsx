        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-yellow-300">Success Story Today</span>
            </h2>
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Special Launch Offer</span>
            </div>
          ...
          >
            <div className="text-sm">✓ Trusted by 15,000+ students</div>
            <div className="text-sm">✓ 4.9/5 average rating</div>
          </motion.div>
        </div>
      </div>
    </section>
