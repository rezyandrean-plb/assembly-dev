...
export default function NewFeaturesSection() {
  ...
  const features = [
    {
      icon: <BookOpen className="w-8 h-8" data-oid="mfjr.n_" />,
    ...
    {
      icon: <Users className="w-8 h-8" data-oid="z9k5_ui" />,
    ...
    {
      icon: <TrendingUp className="w-8 h-8" data-oid="daq3:e4" />,
    ...
    {
      icon: <Shield className="w-8 h-8" data-oid="bh1cv7y" />,
    ...
    {
      icon: <Clock className="w-8 h-8" data-oid="_orf2gg" />,
    ...
    {
      icon: <Award className="w-8 h-8" data-oid="kvbxz_6" />,
      title: "Certification",
      description:
  ...
  const stats = [
    {
      icon: <Target className="w-6 h-6" data-oid="ch_br6z" />,
      value: "95%",
      label: "Success Rate",
      description: "Of our students achieve their investment goals",
    },
    {
      icon: <Lightbulb className="w-6 h-6" data-oid="-yuirma" />,
      value: "50+",
      label: "Expert Instructors",
      description: "Industry professionals sharing their knowledge",
    },
    {
      icon: <BarChart3 className="w-6 h-6" data-oid="b89aaz0" />,
      value: "$2.5B+",
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white" data-oid="8gqx23c">
      <div className="container mx-auto px-4" data-oid="jpyu9e2">
        {/* Header */}
        <motion.div
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed" data-oid="w9r0oxw">
                {feature.description}
              </p>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          data-oid="aoefaqm"
        >
          <div className="text-center mb-12" data-oid="z.po_:t">
            <h3
            ...
            <p className="text-gray-600 text-lg" data-oid="ugunb1d">
              Join thousands of successful investors who've transformed their
              financial future
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8" data-oid="_le7p4j">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  ...
                  data-oid="_:bryqk"
                >
                  <div className="text-primary" data-oid="986unw-">
                    {stat.icon}
                  </div>
                </div>
                <div
                ...
                <div className="text-gray-600" data-oid="8u:rsqi">
                  {stat.description}
                </div>
              </motion.div>
            ))}
