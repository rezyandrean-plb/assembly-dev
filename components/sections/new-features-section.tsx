...
export default function NewFeaturesSection() {
  ...
  const features = [
    {
      icon: <BookOpen className="w-8 h-8" data-oid="15y65yb" />,
    ...
    {
      icon: <Users className="w-8 h-8" data-oid="2fsj.fe" />,
    ...
    {
      icon: <TrendingUp className="w-8 h-8" data-oid="_1__e1_" />,
    ...
    {
      icon: <Shield className="w-8 h-8" data-oid="eccdnk4" />,
    ...
    {
      icon: <Clock className="w-8 h-8" data-oid="i5j3gg8" />,
    ...
    {
      icon: <Award className="w-8 h-8" data-oid="0v4ht2h" />,
      title: "Certification",
      description:
  ...
  const stats = [
    {
      icon: <Target className="w-6 h-6" data-oid="umf-jg9" />,
      value: "95%",
      label: "Success Rate",
      description: "Of our students achieve their investment goals",
    },
    {
      icon: <Lightbulb className="w-6 h-6" data-oid="ptx-6a-" />,
      value: "50+",
      label: "Expert Instructors",
      description: "Industry professionals sharing their knowledge",
    },
    {
      icon: <BarChart3 className="w-6 h-6" data-oid="7pcj.-5" />,
      value: "$2.5B+",
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white" data-oid="91tkdpl">
      <div className="container mx-auto px-4" data-oid="lob.a8q">
        {/* Header */}
        <motion.div
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed" data-oid=".kvf175">
                {feature.description}
              </p>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          data-oid="pgj-ir2"
        >
          <div className="text-center mb-12" data-oid="fq3:m:u">
            <h3
            ...
            <p className="text-gray-600 text-lg" data-oid="xb1k1gc">
              Join thousands of successful investors who've transformed their
              financial future
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8" data-oid="3mrf59y">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  ...
                  data-oid="v0w0cow"
                >
                  <div className="text-primary" data-oid="rvbj_bg">
                    {stat.icon}
                  </div>
                </div>
                <div
                ...
                <div className="text-gray-600" data-oid="luevjc7">
                  {stat.description}
                </div>
              </motion.div>
            ))}
