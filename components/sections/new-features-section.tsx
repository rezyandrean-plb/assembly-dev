...
export default function NewFeaturesSection() {
  ...
  const features = [
    {
      icon: <BookOpen className="w-8 h-8" data-oid="yka17_4" />,
    ...
    {
      icon: <Users className="w-8 h-8" data-oid="hucb1c8" />,
    ...
    {
      icon: <TrendingUp className="w-8 h-8" data-oid="m_ed3uv" />,
    ...
    {
      icon: <Shield className="w-8 h-8" data-oid="rqb6u-." />,
    ...
    {
      icon: <Clock className="w-8 h-8" data-oid="dzu6ceu" />,
    ...
    {
      icon: <Award className="w-8 h-8" data-oid="_ja5d6c" />,
      title: "Certification",
      description:
  ...
  const stats = [
    {
      icon: <Target className="w-6 h-6" data-oid="5ci3m1i" />,
      value: "95%",
      label: "Success Rate",
      description: "Of our students achieve their investment goals",
    },
    {
      icon: <Lightbulb className="w-6 h-6" data-oid="9fjiesm" />,
      value: "50+",
      label: "Expert Instructors",
      description: "Industry professionals sharing their knowledge",
    },
    {
      icon: <BarChart3 className="w-6 h-6" data-oid="b36y_n0" />,
      value: "$2.5B+",
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white" data-oid="kyemn5j">
      <div className="container mx-auto px-4" data-oid="ynkz4_9">
        {/* Header */}
        <motion.div
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed" data-oid=":mykzfq">
                {feature.description}
              </p>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          data-oid="yerc8.g"
        >
          <div className="text-center mb-12" data-oid="ltgxpi0">
            <h3
            ...
            <p className="text-gray-600 text-lg" data-oid="h.p3h3a">
              Join thousands of successful investors who've transformed their
              financial future
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8" data-oid="0xx1w8g">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  ...
                  data-oid="sjmx-7j"
                >
                  <div className="text-primary" data-oid="h03lzp7">
                    {stat.icon}
                  </div>
                </div>
                <div
                ...
                <div className="text-gray-600" data-oid="fd36r._">
                  {stat.description}
                </div>
              </motion.div>
            ))}
