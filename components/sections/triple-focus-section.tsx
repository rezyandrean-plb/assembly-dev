  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="wqx_70z">
        ...
        <p className="text-gray-300 mb-8" data-oid="3yb9s1s">
          {description}
        </p>
        <div
        ...
        >
          {focusPoints.map((point, index) => (
            <div
              ...
              data-oid="_4ju5j4"
            >
              <div className="text-4xl mb-4" data-oid="1zaw.bz">
                {point.icon}
              </div>
              <h3 className="text-xl font-semibold mb-2" data-oid="_pnoxny">
                {point.title}
              </h3>
              <p className="text-gray-300" data-oid="kspru:z">
                {point.description}
              </p>
            </div>
          ))}
