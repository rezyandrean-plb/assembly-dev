...
const TripleFocusSection: React.FC<TripleFocusSectionProps> = ({ title, description, focusPoints }) => {
  ...
  useEffect(() => {
    ...
    const drawNetwork = () => {
      ...
      const connectPoints = (point1: { x: number; y: number }, point2: { x: number; y: number }) => {
