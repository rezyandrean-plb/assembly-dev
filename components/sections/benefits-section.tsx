...
export default function BenefitsSection() {
  ...
  const benefits = [
    {
      icon: <BookOpen className="h-6 w-6 text-[#123B79]" data-oid="7u11lw2" />,
    ...
    {
      icon: <Compass className="h-6 w-6 text-[#123B79]" data-oid="met5tx." />,
    ...
    {
      icon: <BarChart2 className="h-6 w-6 text-[#123B79]" data-oid="udwhz3h" />,
      title: "Career Growth",
      description:
    ...
    {
      icon: <Shield className="h-6 w-6 text-[#123B79]" data-oid="sczkew1" />,
    ...
    {
      icon: <Zap className="h-6 w-6 text-[#123B79]" data-oid="5avmwa-" />,
    ...
    {
      icon: <Award className="h-6 w-6 text-[#123B79]" data-oid="wl7nhuu" />,
  ...
  return (
    <section
      ...
      data-oid="4tel9bv"
    >
      <div className="container mx-auto px-4" data-oid="5awosj7">
        <motion.div
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div data-oid="xv785gb">
                ...
                <p className="text-gray-600" data-oid="m_8xccl">
                  {benefit.description}
                </p>
              </div>
            </motion.div>
