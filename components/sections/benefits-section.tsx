...
export default function BenefitsSection() {
  ...
  const benefits = [
    {
      icon: <BookOpen className="h-6 w-6 text-[#123B79]" data-oid="199yh7:" />,
    ...
    {
      icon: <Compass className="h-6 w-6 text-[#123B79]" data-oid="lj6o9_s" />,
    ...
    {
      icon: <BarChart2 className="h-6 w-6 text-[#123B79]" data-oid="lw63q20" />,
      title: "Career Growth",
      description:
    ...
    {
      icon: <Shield className="h-6 w-6 text-[#123B79]" data-oid="gcolc2i" />,
    ...
    {
      icon: <Zap className="h-6 w-6 text-[#123B79]" data-oid="536f3vg" />,
    ...
    {
      icon: <Award className="h-6 w-6 text-[#123B79]" data-oid="8wo..9r" />,
  ...
  return (
    <section
      ...
      data-oid="tjoyjm2"
    >
      <div className="container mx-auto px-4" data-oid="s-:uxek">
        <motion.div
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div data-oid="4ln:nee">
                ...
                <p className="text-gray-600" data-oid="f6r._-3">
                  {benefit.description}
                </p>
              </div>
            </motion.div>
