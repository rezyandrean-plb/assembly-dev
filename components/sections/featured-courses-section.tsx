...
export default function FeaturedCoursesSection() {
  ...
  return (
    <section
      ...
      data-oid="q.99ptw"
    >
      <div className="container mx-auto px-4" data-oid="cp7u859">
        <motion.div
        ...
        <div className="space-y-24" data-oid="w6wv.3q">
          {courses.map((course, index) => (
            <motion.div
              ...
              data-oid="3p1.o5:"
            >
              <div className="md:w-1/2 order-2 md:order-1" data-oid="ji3k59h">
                <div
                ...
                <p className="text-lg text-gray-700 mb-6" data-oid="g67n.s3">
                  {course.description}
                </p>

                <div className="flex space-x-4 mb-6" data-oid="8:t.:27">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg
                      key={star}
                ...
                >
                  Explore this course
                  <ArrowRight className="ml-2 h-4 w-4" data-oid="8bd2jl:" />
                </a>
              </div>

              <div className="md:w-1/2 order-1 md:order-2" data-oid="xkom.m9">
                <div
