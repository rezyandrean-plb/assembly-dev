...
export default function CondoPathSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" data-oid="ncf9::a">
        <svg
        ...
        >
          ...
          {segments.map((segment, index) => {
            ...
            return (
              <motion.g key={`segment-${index}`} data-oid=":tn0tcn">
                {/* Segment circle */}
                <motion.circle
                  cx={segment.x}
                  cy={segment.y}
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="o8p9bcl">
        <motion.div
        ...
        <div className="max-w-4xl mx-auto" data-oid="qmmy94q">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-700 mb-6" data-oid="yyj6:-g">
            ...
            <p className="text-gray-700 mb-6" data-oid="hui9r12">
            ...
            <div className="flex justify-center mt-8" data-oid="scnav42">
              <Button
                className="bg-[#79123B] hover:bg-[#5A0E2C] text-white"
                data-oid="69uj99g"
              >
                Explore This Path
                <ArrowRight className="ml-2 h-4 w-4" data-oid="6jitv2m" />
              </Button>
            </div>
          </motion.div>
        </div>
