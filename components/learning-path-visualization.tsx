    ...
    <div className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="w-16 h-1 bg-[#F0A500] mx-auto mt-4"></div>
        </div>
    ...
    >
      ...
      <div className="p-6">
          ...
          <svg ref={svgRef} width="300" height="80" viewBox="0 0 300 80">
            ...
            {path.nodes.map((node, i) => (
              <g key={i}>
                ...
                />
                {node.label && (
                  <text x={node.x * 300} y={node.y * 80 + 20} textAnchor="middle" fill="#666" fontSize="12">
                    {node.label}
                  </text>
                )}
              </g>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href={`/learning-paths/${path.title.toLowerCase().replace(/\s+/g, "-")}`}>
