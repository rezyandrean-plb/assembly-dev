...
export default function CourseCard({
  ...
  if (size === "small") {
    return (
      <Link href={courseLink} className="block h-full" data-oid="pn4rl8o">
        <motion.div
        ...
        >
          ...
          >
            {/* Image */}
            <div className="w-full flex justify-center" data-oid="j_fp22v">
              <div
            ...
            {/* Title */}
            <div className="w-full mb-2" data-oid="8ag-cea">
              <span
            ...
            >
              {course.rating && course.rating > 0 ? (
                <>
                  ...
                  <span className="ml-1" data-oid="ud-3tp:">
                    {course.reviewCount
                ...
                <span data-oid="n5ysfn:">No Reviews Yet</span>
              )}
            </div>
            ...
            >
              {course.level && (
                <span className="mr-2" data-oid="4q-:i73">
                  {course.level}
                </span>
              )}
              {course.category && (
                <span data-oid="d.ps5t:">• {course.category}</span>
              )}
            </div>
  ...
  return (
    ...
    >
      <div
        ...
        data-oid="l3f4zhq"
      >
        <Link href={courseLink} className="block" data-oid="z:makhx">
          <div
        ...
        >
          ...
          {course.categories && course.categories.length > 0 && (
            <div className="flex flex-wrap gap-1 mb-2" data-oid="0z2igu2">
          ...
          <Link href={courseLink} className="block" data-oid="6k1ocpn">
            <h3
            ...
            <p className={`text-gray-500 mb-2 ${fontSize}`} data-oid=".6w:dhq">
          ...
          >
            {course.rating && course.rating > 0 ? (
              <span className="flex items-center" data-oid="0lnot-0">
                <svg
                ...
                {course.rating.toFixed(1)}
                {course.reviewCount && (
                  <span className="ml-1" data-oid="y7wdmra">
                    ({course.reviewCount})
                  </span>
                )}
              </span>
            ) : (
              <span data-oid="58epb_u">No Reviews Yet</span>
            )}

            {/* Show duration if available */}
            {course.duration && (
              <>
                <span className="mx-2" data-oid="enn76c9">
                  •
                </span>
                <span data-oid="8x9ez6w">{course.duration}</span>
              </>
            )}
          </div>

          {/* Subtle divider */}
          <div className="mt-auto pt-3" data-oid="-ejfeh4">
            <div
