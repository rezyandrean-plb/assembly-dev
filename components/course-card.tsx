...
export default function CourseCard({
  ...
  if (size === "small") {
    return (
      <Link href={courseLink} className="block h-full" data-oid="-ignxjs">
        <motion.div
        ...
        >
          ...
          >
            {/* Image */}
            <div className="w-full flex justify-center" data-oid="wpgayx0">
              <div
            ...
            {/* Title */}
            <div className="w-full mb-2" data-oid="8jm9e14">
              <span
            ...
            >
              {course.rating && course.rating > 0 ? (
                <>
                  ...
                  <span className="ml-1" data-oid="u:f_0.d">
                    {course.reviewCount
                ...
                <span data-oid="mzkycnb">No Reviews Yet</span>
              )}
            </div>
            ...
            >
              {course.level && (
                <span className="mr-2" data-oid="kheocee">
                  {course.level}
                </span>
              )}
              {course.category && (
                <span data-oid="c5v.83q">• {course.category}</span>
              )}
            </div>
  ...
  return (
    ...
    >
      <div
        ...
        data-oid="pjis0ya"
      >
        <Link href={courseLink} className="block" data-oid="zbo:4jc">
          <div
        ...
        >
          ...
          {course.categories && course.categories.length > 0 && (
            <div className="flex flex-wrap gap-1 mb-2" data-oid="bxprmoj">
          ...
          <Link href={courseLink} className="block" data-oid="pb3b420">
            <h3
            ...
            <p className={`text-gray-500 mb-2 ${fontSize}`} data-oid="6a3-jmm">
          ...
          >
            {course.rating && course.rating > 0 ? (
              <span className="flex items-center" data-oid="g:z58pb">
                <svg
                ...
                {course.rating.toFixed(1)}
                {course.reviewCount && (
                  <span className="ml-1" data-oid="_spm_y:">
                    ({course.reviewCount})
                  </span>
                )}
              </span>
            ) : (
              <span data-oid="enxgt5b">No Reviews Yet</span>
            )}

            {/* Show duration if available */}
            {course.duration && (
              <>
                <span className="mx-2" data-oid="_v._x92">
                  •
                </span>
                <span data-oid="8jbgbej">{course.duration}</span>
              </>
            )}
          </div>

          {/* Subtle divider */}
          <div className="mt-auto pt-3" data-oid="g8sl4zo">
            <div
