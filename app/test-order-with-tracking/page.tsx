...
export default function TestOrderWithTrackingPage() {
  const router = useRouter();

  useEffect(() => {
    // Create mock order details WITH tracking number
    const mockOrderDetails = {
      orderId: `ORD-${Date.now()}-WITHTRACK`,
      ...
      hasBooks: true,
      trackingNumber: "ASG12345678READY", // This time WITH tracking number
    };
  ...
  return (
    <div
      ...
      data-oid="vyyg6xg"
    >
      <div className="text-center" data-oid="gifidlh">
        <div
          className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#123b79] mx-auto mb-4"
          data-oid="8tws3xr"
        ></div>
        <p className="text-gray-600" data-oid="mx58l30">
