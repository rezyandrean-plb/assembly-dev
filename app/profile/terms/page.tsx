  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <p className="font-medium">Effective Date: 31 May 2024</p>
        ...
        <ol className="list-decimal pl-6 space-y-4 mt-6">
          <li>
            ...
            accessing or using the Services, you confirm that you have read,
            understood, and agree to be bound by these Terms and our Privacy
            Policy. If you are using the Services on behalf of an organization,
            you represent and warrant that you have the authority to bind that
            organization to these Terms.
          </li>

          <li>
            <span className="font-semibold">Eligibility:</span> Our Services are
            intended for users who are at least 18 years old. By using our
          ...
          <li>
            ...
            access certain features of our Services, you may need to register
            ...
            as prompted by our registration form. You are responsible for
          ...
          <li>
            ...
            use our Services only for lawful purposes and in a way that does not
            infringe the rights of, restrict, or inhibit anyone else's use and
            enjoyment of the Services. Prohibited behavior includes but is not
            limited to:
          ...
          <li>
            ...
            logos, videos, and course materials, is the property of Assembly or
          ...
          <li>
            <span className="font-semibold">User-Generated Content:</span> You
            may have the opportunity to contribute content, such as discussion
            posts or project submissions, to our Services. By submitting
            content, you grant Assembly a non-exclusive, worldwide, royalty-free
            license to use, reproduce, modify, and distribute your content in
            connection with our Services. You represent and warrant that you
            have the right to grant this license and that your content does not
            violate any laws or infringe the rights of any third party.
          </li>

          <li>
            <span className="font-semibold">Payments and Refunds:</span> Certain
            parts of our Services may require payment. All fees are
            non-refundable except as required by law or as stated in our refund
            policy. We reserve the right to change our fees at any time, and any
          ...
          <li>
            ...
            are not owned or controlled by Assembly. We are not responsible for
            the content, privacy policies, or practices of any third-party
            websites or services. You access third-party websites at your own
            risk.
          </li>

          <li>
            <span className="font-semibold">Termination:</span> We may terminate
            or suspend your access to our Services at any time, without prior
          ...
          <li>
            <span className="font-semibold">Disclaimers:</span> Our Services are
            provided on an "as-is" and "as-available" basis. We make no
            warranties, express or implied, regarding the availability,
            accuracy, or reliability of our Services. We disclaim all warranties
            to the fullest extent permitted by law.
          </li>

          <li>
            <span className="font-semibold">Limitation of Liability:</span> To
            the fullest extent permitted by law, Assembly shall not be liable
          ...
          <li>
            ...
            Singapore, without regard to its conflict of law principles. Any
            disputes arising out of or in connection with these Terms shall be
            resolved exclusively in the courts of Singapore.
          </li>

          <li>
            <span className="font-semibold">Changes to Terms:</span> We may
            modify these Terms at any time. Any changes will be effective
            immediately upon posting the revised Terms on our website. Your
        ...
        <p className="mt-6">Thank you for being a part of Assembly!</p>
      </div>
    </div>
  );
}
