  ...
  return (
    ...
    >
      ...
      <button
        ...
        data-oid="ia61z.7"
      >
        <ChevronLeft className="h-6 w-6" data-oid="y1:tvix" />
      </button>
      ...
      <button
        ...
        data-oid="m45z4am"
      >
        <ChevronRight className="h-6 w-6" data-oid="05gscw." />
      </button>

      {/* Carousel container with consistent padding */}
      <div className="px-8" data-oid="uc6v3v_">
        {/* Carousel track */}
        <div
      ...
      {/* Navigation dots */}
      <div className="flex justify-center mt-6 gap-2" data-oid="8x1_s6:">
