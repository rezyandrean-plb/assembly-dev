  ...
  return (
    ...
    >
      ...
      <button
        ...
        data-oid="0_40zn2"
      >
        <ChevronLeft className="h-6 w-6" data-oid="sp4grv7" />
      </button>
      ...
      <button
        ...
        data-oid="j5ulrh:"
      >
        <ChevronRight className="h-6 w-6" data-oid="myk6wjn" />
      </button>

      {/* Carousel container with consistent padding */}
      <div className="px-8" data-oid="wv633ap">
        {/* Carousel track */}
        <div
      ...
      {/* Navigation dots */}
      <div className="flex justify-center mt-6 gap-2" data-oid="e6:7qtl">
