    ...
    function drawCityscape() {
      ...
      buildings.forEach((building) => {
        ...
        for (let i = 0; i < building.windows; i++) {
          ...
          if (windowY + windowHeight < building.y + building.height) {
            ctx.fillStyle = building.windowLights[i]
              ? "rgba(255, 206, 84, 0.8)"
      ...
      if (Math.random() > 0.95) {
        ...
        const windowIndex = Math.floor(
          Math.random() * buildings[buildingIndex].windows,
        );
        buildings[buildingIndex].windowLights[windowIndex] =
          !buildings[buildingIndex].windowLights[windowIndex];
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div ref={ctaRef} className="hero-cta opacity-0" data-oid="h9ocibl">
          <Button
            size="lg"
      ...
      <div
        ...
        data-oid="m4uiu6n"
      >
        <p className="text-sm mb-2" data-oid="ws59ibd">
          Scroll to explore
        </p>
        <ArrowDown
