...
export default function IntroSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white" data-oid="iw:u2-.">
      <div className="container mx-auto px-4" data-oid="jrm2997">
        <div className="max-w-4xl mx-auto" data-oid="vb255e6">
          <div
            ref={titleRef}
            className="intro-title text-center mb-8"
            data-oid="6iodb:y"
          >
            <h2 className="text-4xl font-bold text-gray-900" data-oid="tw6zed-">
          ...
          >
            <div
              ...
              data-oid="sama91c"
            >
              <p className="text-lg text-gray-700 mb-6" data-oid="t1lizxj">
              ...
              <p className="text-lg text-gray-700" data-oid="yaptvkx">
            ...
            <div
              ...
              data-oid="97k:7r0"
            >
              <div className="relative w-48 h-48" data-oid="w9nfvib">
                <div
