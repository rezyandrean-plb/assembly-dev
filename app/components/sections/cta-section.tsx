...
export default function CtaSection() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="ltcxw_-">
        <div
          ...
          >
            ...
            >
              <Button
                ...
                data-oid="2cyzixa"
              >
                <BookOpen className="mr-2 h-5 w-5" data-oid="1sfl0yl" />
                Explore Content
                <ArrowRight className="ml-2 h-5 w-5" data-oid="nez:mkf" />
              </Button>
            </motion.div>
            ...
            >
              <Button
                ...
                data-oid="bbdn4d3"
              >
                <Users className="mr-2 h-5 w-5" data-oid="waf3qjx" />
                Join Community
                <ArrowRight className="ml-2 h-5 w-5" data-oid="e8ogmo8" />
              </Button>
            </motion.div>
          </div>
        </div>
