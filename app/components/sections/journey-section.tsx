...
export default function JourneySection() {
  ...
  const milestones = [
    {
      ...
      icon: <BookOpen className="h-8 w-8" data-oid=":bgzv1s" />,
    },
    {
      name: "Foundation",
      description: "Build your knowledge base",
      icon: <Lightbulb className="h-8 w-8" data-oid="8orqtsi" />,
    },
    {
      name: "Application",
      description: "Apply concepts to real scenarios",
      icon: <Target className="h-8 w-8" data-oid="74:bwxj" />,
    },
    {
      name: "Mastery",
      description: "Develop advanced expertise",
      icon: <TrendingUp className="h-8 w-8" data-oid=":vcgmdy" />,
    },
    {
      name: "Leadership",
      description: "Become an industry authority",
      icon: <Award className="h-8 w-8" data-oid="356r22r" />,
    },
    {
      name: "Innovation",
      description: "Create new approaches",
      icon: <Star className="h-8 w-8" data-oid="_rd2vsj" />,
    },
  ];
  ...
  return (
    <section
      ...
      data-oid="bo44i.i"
    >
      <div className="container mx-auto px-4" data-oid="gkef8vn">
        <motion.div
          ...
          data-oid="wfy8ydk"
        >
          <h2 className="text-5xl font-bold" data-oid="fo3o174">
        ...
        <div className="relative max-w-5xl mx-auto" data-oid="y3m4i2n">
          {/* SVG Path */}
          <svg
            ref={svgRef}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-300 text-base" data-oid="o10-.9a">
