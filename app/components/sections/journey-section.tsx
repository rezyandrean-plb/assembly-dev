...
import { BookOpen, Award, Lightbulb, Target, TrendingUp, Star } from "lucide-react"
...
export default function JourneySection() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (scrollPosition > triggerPoint) {
        ...
        sectionScrollPercentage = Math.min(1, (scrollPosition - triggerPoint) / scrollableDistance)
  ...
  // Define milestones
  const milestones = [
    { name: "Awareness", description: "Discover the fundamentals", icon: <BookOpen className="h-8 w-8" /> },
    { name: "Foundation", description: "Build your knowledge base", icon: <Lightbulb className="h-8 w-8" /> },
    { name: "Application", description: "Apply concepts to real scenarios", icon: <Target className="h-8 w-8" /> },
    { name: "Mastery", description: "Develop advanced expertise", icon: <TrendingUp className="h-8 w-8" /> },
    { name: "Leadership", description: "Become an industry authority", icon: <Award className="h-8 w-8" /> },
    { name: "Innovation", description: "Create new approaches", icon: <Star className="h-8 w-8" /> },
  ]
  ...
  return (
    <section ref={sectionRef} className="py-32 bg-gray-900 text-white min-h-[100vh]">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          >
            ...
            <circle cx="400" cy="400" r="320" stroke="rgba(249, 115, 22, 0.1)" strokeWidth="1" fill="none" />
            <circle cx="400" cy="400" r="360" stroke="rgba(249, 115, 22, 0.1)" strokeWidth="1" fill="none" />
            ...
            {Array.from({ length: 60 }).map((_, i) => {
              ...
              return (
                <line
                  ...
                  stroke={i % 5 === 0 ? "rgba(249, 115, 22, 0.4)" : "rgba(249, 115, 22, 0.2)"}
            ...
            >
              ...
              <path d="M 400 20 A 380 380 0 0 1 710 260" stroke="#f97316" strokeWidth="12" fill="none" />
              <path d="M 710 540 A 380 380 0 0 1 400 780" stroke="#84cc16" strokeWidth="12" fill="none" />
            </motion.g>
            ...
            />
            <text x="400" y="408" textAnchor="middle" fill="white" fontWeight="bold" fontSize="20">
              YOU
            </text>
              ...
              return (
                <g key={index}>
                  ...
                  <motion.foreignObject
                    ...
                    animate={shouldShow ? { opacity: 1, scale: 1, rotate: 0 } : { opacity: 0, scale: 0.5, rotate: 45 }}
                    transition={{ duration: 0.5, delay: 0.2, type: "spring", stiffness: 100 }}
                  >
                    <div className="flex items-center justify-center text-white">{milestone.icon}</div>
                  </motion.foreignObject>
                </g>
              )
            })}
          ...
          {milestones.map((milestone, index) => {
            ...
            return (
              ...
              >
                <div className={`bg-gray-800 p-5 rounded-lg shadow-lg border border-gray-700 w-64 text-center`}>
                  <h4 className="font-bold text-orange-500 text-xl mb-1">{milestone.name}</h4>
