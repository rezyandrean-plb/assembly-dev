...
export default function TripleFocusSection() {
  ...
  const focusAreas = [
    {
      icon: (
        <Building2 className="h-12 w-12 text-orange-500" data-oid="bn9s6tn" />
      ),
    ...
    {
      icon: (
        <TrendingUp className="h-12 w-12 text-blue-500" data-oid="yxyp3_1" />
      ),
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="-x4n754">
        <motion.div
          ...
          data-oid="n1dtq7."
        >
          <h2 className="text-4xl font-bold text-gray-900" data-oid="bgismg_">
            Our Triple Focus
          </h2>
          <p
        ...
        >
          {focusAreas.map((focus, index) => (
            ...
            >
              ...
              <p className="text-gray-600" data-oid="ff69_qf">
                {focus.description}
              </p>
