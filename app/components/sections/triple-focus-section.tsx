...
export default function TripleFocusSection() {
  ...
  const focusAreas = [
    {
      icon: (
        <Building2 className="h-12 w-12 text-orange-500" data-oid="zn7o8:w" />
      ),
    ...
    {
      icon: (
        <TrendingUp className="h-12 w-12 text-blue-500" data-oid="rmq.zrq" />
      ),
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="jxf8pxx">
        <motion.div
          ...
          data-oid="xr0j20i"
        >
          <h2 className="text-4xl font-bold text-gray-900" data-oid="nri1i1:">
            Our Triple Focus
          </h2>
          <p
        ...
        >
          {focusAreas.map((focus, index) => (
            ...
            >
              ...
              <p className="text-gray-600" data-oid="f-fhgsb">
                {focus.description}
              </p>
