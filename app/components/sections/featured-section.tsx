...
export default function FeaturedSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gray-50" data-oid="_2zu8ba">
      <div className="container mx-auto px-4" data-oid="p5c_n8u">
        <div
        ...
        >
          ...
          <div className="md:w-1/2" data-oid="ngljv_8">
            <motion.h3
            ...
            <div className="relative h-24 w-full mb-6" data-oid="-icbpbf">
              {[0, 1, 2, 3].map((i) => (
                <motion.div
                  key={i}
            ...
            >
              ...
              <ArrowRight className="ml-2 h-4 w-4" data-oid="bp7jnb6" />
            </motion.a>
          </div>
        </div>
      </div>
