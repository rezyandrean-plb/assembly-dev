...
export default function FeaturedSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gray-50" data-oid="en8p:qo">
      <div className="container mx-auto px-4" data-oid="14j5htq">
        <div
        ...
        >
          ...
          <div className="md:w-1/2" data-oid="s5tz_cr">
            <motion.h3
            ...
            <div className="relative h-24 w-full mb-6" data-oid="kx:7e4f">
              {[0, 1, 2, 3].map((i) => (
                <motion.div
                  key={i}
            ...
            >
              ...
              <ArrowRight className="ml-2 h-4 w-4" data-oid="iw4kcpr" />
            </motion.a>
          </div>
        </div>
      </div>
