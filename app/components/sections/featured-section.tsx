...
export default function FeaturedSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gray-50" data-oid="muevl87">
      <div className="container mx-auto px-4" data-oid="5jetm1w">
        <div
        ...
        >
          ...
          <div className="md:w-1/2" data-oid="r3ibbw:">
            <motion.h3
            ...
            <div className="relative h-24 w-full mb-6" data-oid=".33pb:4">
              {[0, 1, 2, 3].map((i) => (
                <motion.div
                  key={i}
            ...
            >
              ...
              <ArrowRight className="ml-2 h-4 w-4" data-oid="tg:f03r" />
            </motion.a>
          </div>
        </div>
      </div>
