  ...
  return (
    ...
    >
      <div
        ...
        data-oid="z9ko:4m"
      >
        <div className="relative h-48 overflow-hidden" data-oid="mp1ci5b">
          <Image
        ...
        <div className="p-6 flex flex-col flex-grow" data-oid="f8k-gym">
          <h3 className="text-xl font-bold mb-3" data-oid="4bv.3se">
            {course.title}
          </h3>
          <div className="text-gray-400 text-sm mb-4" data-oid="bm94hx6">
            <span className="inline-block mr-4" data-oid="6_g5qcs">
              ⏱️ {course.duration}
            </span>
          </div>

          <div className="mt-auto" data-oid="_4.zdus">
            <Link
            ...
            >
              Learn More
              <ArrowRight className="ml-2 h-4 w-4" data-oid="vtz_7m8" />
            </Link>
          </div>
        </div>
      </div>
