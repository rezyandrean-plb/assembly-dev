  ...
  return (
    ...
    >
      ...
      <button
        ...
        data-oid=":y39l4x"
      >
        <ChevronLeft className="h-6 w-6" data-oid="bc-z9k_" />
      </button>
      ...
      <button
        ...
        data-oid="1afhduz"
      >
        <ChevronRight className="h-6 w-6" data-oid="n29hq_." />
      </button>

      {/* Carousel container with consistent padding */}
      <div className="px-8" data-oid="vo20ow0">
        {/* Carousel track */}
        <div
      ...
      {/* Navigation dots */}
      <div className="flex justify-center mt-6 gap-2" data-oid="4.-cfq9">
