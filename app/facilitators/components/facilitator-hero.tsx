  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-blue-100/60 rounded-full blur-xl" />

        <div className="absolute bottom-20 right-10 w-24 h-24 bg-orange-100/60 rounded-full blur-xl" />

        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-100/50 to-orange-100/50 rounded-full blur-3xl" />
      </div>
