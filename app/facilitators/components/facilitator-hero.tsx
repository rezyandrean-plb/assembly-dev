...
export function FacilitatorHero() {
  ...
  return (
    ...
    >
      {/* Background Elements */}
      <div className="absolute inset-0" data-oid="vqn5zec">
        <div
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="_n64yo5">
        <div className="max-w-4xl mx-auto text-center" data-oid="1aoks65">
          <motion.div
          ...
          >
            Meet Your
            <span className="block text-blue-900" data-oid="kvkw9k1">
