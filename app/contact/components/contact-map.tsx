...
export default function ContactMap() {
  ...
  return (
    <div className="relative w-full h-full bg-blue-50" data-oid="75nhx-4">
      {/* Decorative background */}
      <div className="absolute inset-0 overflow-hidden" data-oid="ls7h840">
        {/* Grid lines */}
        <div
      ...
      >
        <motion.div
          ...
          data-oid="k0_ulh_"
        >
          <div className="relative" data-oid="uwp-za3">
            <MapPin
      ...
      <motion.div
        ...
        data-oid="4ilah-."
      >
        <div className="flex items-start gap-3" data-oid="tpvxm9v">
          <div className="bg-blue-100 p-2 rounded-full" data-oid="0ajz48w">
            <MapPin className="h-5 w-5 text-blue-600" data-oid="f3sfit5" />
          </div>
          <div className="flex-1" data-oid="ixvlb_r">
            <h3 className="font-bold text-gray-900" data-oid="js1thc-">
              {location.name}
            </h3>
            <p className="text-gray-600 text-sm" data-oid="5i:k1cu">
              {location.address}
            </p>
            <a
            ...
            >
              Get Directions
              <ExternalLink className="ml-1 h-3 w-3" data-oid="mhn_fci" />
            </a>
          </div>
        </div>
