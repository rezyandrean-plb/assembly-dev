  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* Screen content */}
        <div className="w-full h-full bg-gradient-to-b from-blue-50 to-white p-4 pt-8 flex flex-col">
          {/* App header */}
          <div className="text-center mb-4">
            <h3 className="font-bold text-blue-900">Assembly SG</h3>
            <p className="text-xs text-gray-500">Contact Us</p>
          </div>

          {/* Messages */}
          <div className="flex-1 overflow-hidden flex flex-col justify-end space-y-3">
            <motion.div
          ...
          {/* Message input */}
          <div className="mt-3 bg-white rounded-full border border-gray-300 flex items-center p-1 shadow-sm">
            <div className="flex-1 px-2">
              <div className="h-5 w-full bg-gray-100 rounded-full"></div>
            </div>
            <motion.div
