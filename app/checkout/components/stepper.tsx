...
export default function Stepper({ currentStep, hasBook }: StepperProps) {
  ...
  return (
    <div className="w-full py-8 bg-white border-b" data-oid="z45c-wf">
      <div className="max-w-6xl mx-auto px-4" data-oid="5q8vmd2">
        <div className="flex items-center justify-center" data-oid="vmkunik">
            ...
            return (
              <React.Fragment key={step.id}>
                ...
                >
                  ...
                  >
                    {isCompleted ? (
                      <Check className="w-5 h-5" data-oid="ygq5lgg" />
                    ) : (
                      step.id
                    )}
                  </div>
                  <div className="mt-2 text-center" data-oid="xukyp0g">
                    <p
                    ...
                    <p className="text-xs text-gray-400" data-oid="8xk5w-m">
                      {step.label}
                    </p>
                  </div>
                </div>
