...
export default function Stepper({ currentStep, hasBook }: StepperProps) {
  ...
  return (
    <div className="w-full py-8 bg-white border-b" data-oid="xh-78hw">
      <div className="max-w-6xl mx-auto px-4" data-oid="1ihrpq1">
        <div className="flex items-center justify-center" data-oid="_ev53wv">
            ...
            return (
              <React.Fragment key={step.id}>
                ...
                >
                  ...
                  >
                    {isCompleted ? (
                      <Check className="w-5 h-5" data-oid="vb6c3a-" />
                    ) : (
                      step.id
                    )}
                  </div>
                  <div className="mt-2 text-center" data-oid="d9546s-">
                    <p
                    ...
                    <p className="text-xs text-gray-400" data-oid="llx.3if">
                      {step.label}
                    </p>
                  </div>
                </div>
