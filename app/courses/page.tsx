...
export default function CoursesPage() {
  ...
  const [categories, setCategories] = useState([{ id: "all", name: "All Classes" }])
    ...
    const parseCourseData = () => {
      ...
      const courseData = [
        ...
        },
        {
          ...
          categories: ["Condo", "Webinar"],
          instructor: "Marc Chan, Ong Yu Rong, George Peng, Shawn Tay, Jesley Lim",
          price: "Free",
        },
        {
          url: "https://assembly.sg/courses/live-debate-new-launch-condo-vs-resale-condo-which-is-more-profitable/",
          title: "Live Debate - New Launch Condo VS Resale Condo: Which is More Profitable?",
          categories: ["Condo", "Webinar"],
          instructor: "Melvin Lim",
          price: "Free",
        },
        ...
        },
        {
          ...
          categories: ["Condo", "HDB", "Webinar"],
          instructor: "Melvin Lim, Jesley Lim, Lee Jun Wei, Ramzi Razak, Loong Yanyan",
          price: "Free",
        },
        {
        ...
        },
        {
          ...
          instructor: "Melvin Lim, Ong Yu Rong, George Peng, Shawn Tay, Gavin Chan",
          price: "Free",
        },
        {
          ...
          instructor: "Melvin Lim, Grayce Tan, Joan Loh, Sebastian Lau, Lyndon Leong",
          price: "Free",
        },
        {
      ...
      const formattedCourses: Course[] = courseData.map((course, index) => {
        ...
        return {
          ...
          duration: course.categories.includes("Webinar") ? "1 hour" : "Self-paced",
          category: primaryCategory,
          categories: course.categories,
          price: course.price,
          type: course.categories.includes("Masterclass") ? "Masterclass" : "Course",
          image,
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    if (searchQuery) {
      ...
      const matchesTags = course.tags?.some((tag) => tag.toLowerCase().includes(query)) || false
    ...
    // Filter by type
    if (selectedFilters.type.length > 0 && course.type && !selectedFilters.type.includes(course.type)) {
      return false
    }
    ...
    if (selectedFilters.category.length > 0) {
      const categoryMatched = course.categories.some((cat) => selectedFilters.category.includes(cat))
      if (!categoryMatched) {
        return false
      }
    }
  ...
  const sortedCourses = [...filteredCourses].sort((a, b) => {
    if (sortBy === "popular") {
      ...
      const aPrice = a.price === "Free" ? 0 : Number.parseFloat(a.price.replace(/[^0-9.]/g, ""))
      const bPrice = b.price === "Free" ? 0 : Number.parseFloat(b.price.replace(/[^0-9.]/g, ""))
        ...
        <div className="pt-24 pb-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">Master Singapore's property market with expert-led courses</p>
            </div>
            ...
            {activeTab === "courses" ? (
                  ...
                  {showMobileFilters && (
                    <div className="lg:hidden fixed inset-0 bg-white z-50 overflow-y-auto p-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {filterOptions.type.map((type) => (
                            <Button
                              ...
                              size="sm"
                              className={selectedFilters.type.includes(type) ? "bg-[#123B79]" : ""}
                        ...
                        <div className="flex flex-wrap gap-2 max-h-60 overflow-y-auto">
                          {filterOptions.category.map((category) => (
                            <Button
                              ...
                              size="sm"
                              className={selectedFilters.category.includes(category) ? "bg-[#123B79]" : ""}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {filterOptions.level.map((level) => (
                            <Button
                              ...
                              size="sm"
                              className={selectedFilters.level.includes(level) ? "bg-[#123B79]" : ""}
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {filterOptions.price.map((price) => (
                            <Button
                              key={price}
                              variant={selectedFilters.price.includes(price) ? "default" : "outline"}
                              size="sm"
                              className={selectedFilters.price.includes(price) ? "bg-[#123B79]" : ""}
                      ...
                      <div className="flex gap-4 mt-6">
                        ...
                        <Button className="flex-1 bg-[#123B79]" onClick={() => setShowMobileFilters(false)}>
                    ...
                    {sortedCourses.length > 0 && (
                      <div className="mt-12 flex justify-center">
                        <nav className="flex items-center gap-1">
                          ...
                          {Array.from(
                            { length: Math.min(5, Math.ceil(sortedCourses.length / coursesPerPage)) },
                            (_, i) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className={pageNum === currentPage ? "bg-[#123B79] text-white border-[#123B79]" : ""}
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handlePageChange(
                                Math.min(currentPage + 1, Math.ceil(sortedCourses.length / coursesPerPage)),
                              )
                            }
                          >
                            Next
              ...
              <div>
                <div className="text-center mb-12">
                  <h2 className="text-3xl font-bold text-[#123B79] mb-4">Learning Paths</h2>
